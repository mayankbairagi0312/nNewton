...
OpneGLDebugRenderer::OpneGLDebugRenderer() : m_VAO(0), m_VBO(0), m_Shader(std::make_unique<Shader>()), m_Camera(nullptr) {
...
void OpneGLDebugRenderer::DrawLine(const nNewton::nVector3& from, const nNewton::nVector3& to, const  nNewton::nVector4& color) {
